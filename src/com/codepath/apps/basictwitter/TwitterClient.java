...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_URL = "https://api.twitter.com/1.1"; // Change
																			...
																			// API
																			// URL
	public static final String REST_CONSUMER_KEY = "qio8wtJ7pk17c4ZRw49DggUEq"; // Change
																				// this
	public static final String REST_CONSUMER_SECRET = "TGPdzrGMGvwCVRBgFFwmSY0shSVYHhkwM0wVBsZWoETVo1cPOb"; // Change
																											// this
	...
	public void getMoreTimeline(AsyncHttpResponseHandler handler, long max_id) {
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		RequestParams params = new RequestParams();
		params.put("since_id", "1");
	...
	public void getMoreMentionsTimeline(AsyncHttpResponseHandler handler,
			long max_id) {
		String apiUrl = getApiUrl("statuses/mentions_timeline.json");
		RequestParams params = new RequestParams();
		params.put("since_id", "1");
